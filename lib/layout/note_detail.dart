...
import 'package:andri/layout/models/note.dart';
import 'package:andri/layout/utils/database_herper.dart';
...
class NoteDetailState extends State<NoteDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    almtController.text = note.alamat;
        return WillPopScope(
        onWillPop: () {
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      ...
                      updateDate();
                        ...
                        void updateAlmt() {
                        note.alamat= almtController.text;
                        } 
                        void updateEmail() {
